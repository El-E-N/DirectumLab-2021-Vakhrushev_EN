...
import {IRemoveDiscussionAction, IUpdateDiscussions, IUpdateVoteAction} from './discussions-action-creators';
import {ActionType} from '../reducer';

export function reducer(
  state: Array<IDiscussion> = [],
  action: IRemoveDiscussionAction | IUpdateDiscussions | IUpdateVoteAction
): Array<IDiscussion> {
  switch (action.type) {
